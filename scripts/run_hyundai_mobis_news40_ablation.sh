...
SUITE_ID="paper_hyundai_mobis_20251031_ablation_v1"
EVALUATION_ID="paper_hyundai_mobis_20251031_judge_v1"
...
SOURCE_MANIFEST="${SUITE_ROOT}/conditions/full/replicate_01/runs/현대모비스_20251031/executions/${FULL_EXECUTION_ID}/full_pipeline_manifest.json"
