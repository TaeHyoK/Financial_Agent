...
SUITE_ID="paper_skbiopharm_20251031_news40_ablation_v1"
EVALUATION_ID="paper_skbiopharm_20251031_news40_judge_v1"
...
SOURCE_MANIFEST="${SUITE_ROOT}/conditions/full/replicate_01/runs/SK바이오팜_20251031/executions/${FULL_EXECUTION_ID}/full_pipeline_manifest.json"
