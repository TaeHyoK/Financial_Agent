...
from Agent_Team.Strategy_Agent.decision import (
    SCHEMA_REVISION, align_strategy_decision_evidence_plan,
...
class DecisionRationaleTests(unittest.TestCase):
    ...
    def test_projection_and_markdown_preserve_rationale(self):
        ...
        self.assertIn(decision["strategy_brief"]["decision_rationale"]["text"], render_strategy_projection_markdown(projection))
